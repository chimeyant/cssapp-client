  ...
  <div class="home pa-6">
    ...
    >
      ...
      <v-subheader class="text-h6">
        <h4>PERMOHONAN PPKm</h4>
      </v-subheader>
    </v-flex>
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Daftar Seluruh Permohonan PPKm yang tersedia
      </div>
    </v-flex>
              ...
              >
                ...
                <v-list>
                  <v-list-item @click="editRecord(value)">
                    <v-list-item-title>
                      <v-icon :color="theme.color">mdi-shield-check</v-icon>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/supervisor/verifikasi/permohonan-ppkm",
      pagination: true,
    });
  },
  mounted() {},
