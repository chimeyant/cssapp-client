  ...
  <div class="home pa-6">
    ...
    >
      ...
      <v-subheader class="text-h6">
        <h4>VERIFIKASI KOMUNITAS</h4>
      </v-subheader>
    </v-flex>
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Daftar Seluruh Verifikasi Komunitas Yang Tersedia
      </div>
    </v-flex>
          ...
          <v-card-text class="mt-2">
            <v-row>
              ...
              <v-col :cols="device.desktop ? `10` : `12`">
                ...
                <v-col cols="12">
                  <div class="subtitle-1 grey--text">HASIL VERIFIKASI</div>
                </v-col>
                <v-col cols="12">
                  <v-textarea
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/supervisor/verifikasi/komunitas",
      pagination: true,
    });
