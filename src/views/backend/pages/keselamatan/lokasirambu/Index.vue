<template>
  <div class="home pa-6 ">
    <v-flex
      ...
      class="pb-2"
    >
      <v-icon :color="theme.color">mdi-map-legend</v-icon>
    ...
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Seluruh Daftar Lokasi Rambu Yang Tersedia
      </div>
    </v-flex>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "DESA", value: "village.name",  align:'left' },
      { text: "LOKASI", value: "address", width:160, align:'center' },
      { text: "STATUS", value: "status", width:160, align:'center' },
      { text: "AKSI", value: "uuid", width:100, sortable:false, align:'center' },
    ],
    form: {
      new: false,
      edit: false,
