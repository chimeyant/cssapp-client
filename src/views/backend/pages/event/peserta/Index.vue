                ...
                <template v-slot:default="{ active }">
                  ...
                  <v-list-item-action>
                    ...
                    >
                      ...
                      <v-list>
                        <v-list-item @click="setOke(item.id)">
                          <v-list-item-title>
                            <v-icon color="green">mdi-shield-check</v-icon>Set Ok
                          </v-list-item-title>
                        </v-list-item>
                        <v-list-item
                          @click="setCancel(item.id)"
                          v-show="form.btndelete"
                        >
                          <v-list-item-title>
                            <v-icon color="red">mdi-shield-off</v-icon> Set Pembatalan
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "KAB/KOTA", value: "kabupaten", align: "center" },
      ...
      if (this.search != null) {
        return this.records.filter((item) => {
          return (
            ...
            item.instansi.toLowerCase().indexOf(this.search.toLowerCase()) > -1
          );
        });
      } else {
        return this.records;
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/event/daftar-peserta",
      pagination: false,
  ...
  methods: {
    ...
    downloadExcel: async function () {
      try {
        ...
        let { data } = await this.http.post("api/event/daftar-peserta-export");
        ...
        XLSX.utils.book_append_sheet(wb, dataxls, "DAFTAR PESERTA"); // sheetAName is name of Worksheet
